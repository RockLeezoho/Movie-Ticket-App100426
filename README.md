...
![Màn hình đăng nhập](docs/screenshots/login.jpeg)

### 2. Màn hình đăng ký

![Màn hình đăng ký](docs/screenshots/register.jpeg)

### 3. Danh sách phim

![Danh sách phim](docs/screenshots/movies.jpeg)

### 4. Danh sách lịch chiếu

![Danh sách phim](docs/screenshots/showtimes.jpeg)

### 5. Danh sách phim

![Danh sách phim](docs/screenshots/theaters.jpeg)

### 6. Chi tiết phim

![Chi tiết phim](docs/screenshots/movie-details.jpeg)

### 7. Chọn ghế và thanh toán
![Chọn ghế và thanh toán](docs/screenshots/select-seat.jpeg)

![Chọn ghế và thanh toán](docs/screenshots/payment.jpeg)

### 8. Chi tiết giao dịch

![Chi tiết giao dịch](docs/screenshots/payment-detail.jpeg)

### 9. Chi tiết vé

![Chi tiết vé](docs/screenshots/ticket-detail.jpeg)

### 10. Thông báo nhắc giờ chiếu

![Thông báo nhắc giờ chiếu](docs/screenshots/ticket-notification.jpeg)
